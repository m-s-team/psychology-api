...
@Schema(name = "NumericalReasoning")
public record NumericalReasoningDTO(
        ...
        @NotNull
        @Schema(description = "Required time for this subtest in minutes", example = "8")
        int requiredTime,
        @Schema(description = "List of the Questions")
        Set<NumericalReasoningQuestionDTO> questions
) {
}
