...
public class WaisIvResource {
    private final Logger log = LoggerFactory.getLogger(WaisIvResource.class);
    private final WaisIvAssessmentService waisIvAssessmentService;
    private final WaisIvAssessmentMapper waisIvAssessmentMapper;

    public WaisIvResource(WaisIvAssessmentService waisIvAssessmentService, WaisIvAssessmentMapper waisIvAssessmentMapper) {
    ...
    public ResponseEntity<WaisIvAssessmentDTO> createWaisIvAssessment(Principal principal) throws URISyntaxException {
        ...
        return ResponseEntity
                .created(new URI("/waisiv/" + result.id()))
                .body(result);
    }
    ...
    public ResponseEntity<WaisIvAssessmentDTO> updateWaisIvAssessment(
